...
var printVersion = function printVersion() {
  ...
  log(packageFile); // log(packageFile.version);
};
...
_regenerator.default.mark(function _callee5() {
  var interval, packageInfo, _groups, _groups$, major, _groups$2, minor, _groups$3, patch, _groups$4, label, templateFiles;
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _groups = (0, _slicedToArray2.default)((packageInfo.packageVersion.match(versionRegex) || {}).groups, 5), _groups$ = _groups[1], major = _groups$ === void 0 ? 0 : _groups$, _groups$2 = _groups[2], minor = _groups$2 === void 0 ? 0 : _groups$2, _groups$3 = _groups[3], patch = _groups$3 === void 0 ? 0 : _groups$3, _groups$4 = _groups[4], label = _groups$4 === void 0 ? '' : _groups$4;
